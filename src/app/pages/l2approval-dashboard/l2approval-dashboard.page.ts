...
@Component({
  selector: 'app-l2approval-dashboard',
  templateUrl: './l2approval-dashboard.page.html',
  styleUrls: ['./l2approval-dashboard.page.scss'],
})
export class L2approvalDashboardPage implements OnInit {
  searchTerm:any='';
  fromDate: any='';
  toDate: any='';
  pipe:any= DatePipe;
